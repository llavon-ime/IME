...
class Bopomofo {
    ...
    inline static const std::unordered_map<int, char16_t> vkToBopomofo{{
        {VK_1, L'ㄅ'}, {VK_2, L'ㄉ'}, {VK_5, L'ㄓ'}, {VK_8, L'ㄚ'}, {VK_9, L'ㄞ'}, {VK_0, L'ㄢ'}, {VK_OEM_MINUS, L'ㄦ'},
        {VK_Q, L'ㄆ'}, {VK_W, L'ㄊ'}, {VK_E, L'ㄍ'}, {VK_R, L'ㄐ'}, {VK_T, L'ㄔ'}, {VK_Y, L'ㄗ'}, {VK_U, L'ㄧ'},
        {VK_I, L'ㄛ'}, {VK_O, L'ㄟ'}, {VK_P, L'ㄣ'},
        {VK_A, L'ㄇ'}, {VK_S, L'ㄋ'}, {VK_D, L'ㄎ'}, {VK_F, L'ㄑ'}, {VK_G, L'ㄕ'}, {VK_H, L'ㄘ'}, {VK_J, L'ㄨ'},
        {VK_K, L'ㄜ'}, {VK_L, L'ㄠ'}, {VK_OEM_1, L'ㄤ'},
        {VK_Z, L'ㄈ'}, {VK_X, L'ㄌ'}, {VK_C, L'ㄏ'}, {VK_V, L'ㄒ'}, {VK_B, L'ㄖ'}, {VK_N, L'ㄙ'}, {VK_M, L'ㄩ'},
        {VK_OEM_COMMA, L'ㄝ'}, {VK_OEM_PERIOD, L'ㄡ'}, {VK_OEM_2, L'ㄥ'},
        {VK_SPACE, L' '}, {VK_6, L'ˊ'}, {VK_3, L'ˇ'}, {VK_4, L'ˋ'}, {VK_7, L'˙'},
    }};
...
class HanziMapEngine {
    ...
    static std::filesystem::path resolve_table_path(
        ...
        return project_root(loc) / "tables" / "bopomofo_char.json";
    }
